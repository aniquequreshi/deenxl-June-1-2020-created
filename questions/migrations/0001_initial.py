    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review_status', models.CharField(blank=True, choices=[('UNREVIEWED', 'UNREVIEWED'), ('PENDING', 'PENDING'), ('REJECTED', 'REJECTED'), ('ACCEPTED', 'ACCEPTED'), ('FINALIZED', 'FINALIZED')], default='UNREVIEWED', max_length=100, null=True, verbose_name='Review Status')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('last_modified', models.DateTimeField(auto_now=True)),
